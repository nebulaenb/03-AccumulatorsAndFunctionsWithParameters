...
def run_test_digits_in_cube():
    ...
    expected = 9
    answer = digits_in_cube(60)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    expected = 37
    answer = digits_in_cube(76)
...
def run_test_digits_in_power():
    ...
    expected = 37
    answer = digits_in_power(76, 3)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 90
    answer = digits_in_power(987, 6)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
